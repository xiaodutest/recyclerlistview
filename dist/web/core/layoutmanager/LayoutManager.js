...
var WrapGridLayoutManager = /** @class */ (function (_super) {
    ...
    WrapGridLayoutManager.prototype.getOffsetForIndex = function (index) {
        if (this._layouts.length > index) {
            var resultX = 0;
            if (this && this._layouts[index] && this._layouts[index].x) resultX = this._layouts[index].x;
            var resultY = 0;
            if (this && this._layouts[index] && this._layouts[index].y) resultY = this._layouts[index].y;
